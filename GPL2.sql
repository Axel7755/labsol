...
CREATE TABLE IF NOT EXISTS `labsol2`.`proyecto` (
  ...
  `img` LONGTEXT NULL,
  `proy_idsolicitante` INT NOT NULL,
  PRIMARY KEY (`idproyect`, `proy_idsolicitante`),
  INDEX `fk_proyecto_solicitante1_idx` (`proy_idsolicitante` ASC) ,
  CONSTRAINT `fk_proyecto_solicitante1`
    FOREIGN KEY (`proy_idsolicitante`)
